...
export const memoryApi = {
  ...
  updateFact: (pid: string, id: string, data: FactRequest) => api.put<FactResponse>(`${base(pid)}/memory/facts/${id}`, data).then(r => r.data),
  ...
  updateEpisode: (pid: string, id: string, data: EpisodeRequest) => api.put<EpisodeResponse>(`${base(pid)}/memory/episodes/${id}`, data).then(r => r.data),
  ...
  updateChapter: (pid: string, id: string, data: ChapterRequest) => api.put<ChapterResponse>(`${base(pid)}/memory/chapters/${id}`, data).then(r => r.data),
  ...
  updateTrait: (pid: string, id: string, data: TraitRequest) => api.put<TraitResponse>(`${base(pid)}/memory/traits/${id}`, data).then(r => r.data),
