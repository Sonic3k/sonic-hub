          ...
          <div className="flex-1 min-w-0">
            {expanded
              ? <textarea value={title} autoFocus rows={2}
                  ...
                  className="w-full bg-transparent outline-none resize-none border-none font-heading font-semibold text-[15px] leading-snug"
                  style={{ color: '#1a1208', caretColor: col }}
                />
              : <p className="font-heading font-semibold text-[15px] leading-snug" style={{ color: '#1a1208' }}>
                  {problem.title}
                </p>
            }
